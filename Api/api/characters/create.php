...
try {
    ...
    $item = new Character(Database::getConnection(),$receivedData->userId, $receivedData->raceId,$receivedData->level, $receivedData->professionId, $receivedData->classId,$receivedData->factionId);
